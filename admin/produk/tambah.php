                ...
                <form action="" method="POST">
                  ...
                  <tr>
                    <td>
                      ...
                      <textarea rows="5" name="deskripsi" class="form-control" required="" placeholder="Keterangan produk ..." autocomplete="off"></textarea>
                    </td>
                  </tr>
                  <tr>
                    <td align="right">
                     <button type="submit" name="simpan" class="btn btn-success btn-sm">Save</button>
                    </td>
                  </tr>
                </form>
              </table>
...
if ($ada == 1) {
    ...
    $input = mysqli_query($koneksi, "INSERT INTO produk VALUES ('', '$nama', '$harga', '$deskripsi');");
